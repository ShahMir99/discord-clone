...
const ServerSearch: React.FC<ServerSearchProp> = ({ data }) => {
  ...
  return (
    ...
    "
      ...
      "
        ...
        <kbd
          className="pointer-event-none inline-flex h-5 select-none
      items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[15px]
